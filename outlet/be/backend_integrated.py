...
from be.diff.task.tree_diff_task import TreeDiffTask
from be.exec.central import CentralExecutor, ExecPriority
from be.cache_manager import CacheManager
from be.icon_store import IconStorePy
...
from be.uid.uid_generator import PersistentAtomicIntUidGenerator, UidGenerator
from be.diff.task.tree_diff_merge_task import TreeDiffMergeTask
...
class BackendIntegrated(OutletBackend):
    ...
    def get_child_list(self, parent_spid: SinglePathNodeIdentifier, tree_id: TreeID, is_expanding_parent: bool = False, use_filter: bool = False,
        ...
        return self.cacheman.get_child_list(parent_spid, tree_id, is_expanding_parent, use_filter, max_results)
    ...
    def execute_tree_action_list(self, tree_action_list: List[TreeAction]):
        self.cacheman.execute_tree_action_list(tree_action_list=tree_action_list)
