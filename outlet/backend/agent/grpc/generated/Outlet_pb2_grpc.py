...
from outlet.backend.agent.grpc.generated import Outlet_pb2 as outlet_dot_backend_dot_agent_dot_grpc_dot_generated_dot_Outlet__pb2
...
class Outlet(object):
    ...
    def get_child_list_for_node(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/outlet.backend.agent.grpc.generated.Outlet/get_child_list_for_node',
