...
class LocalFileChangeBatchingThread(HasLifecycle, threading.Thread):
    ...
    def _run(self):
        ...
        while not self.was_shutdown:
            ...
            self.backend.executor.submit_async_task(Task(ExecPriority.LIVE_UPDATE, self._apply_update_batch, modified_file_set, other_op_list))
    ...
    def _apply_update_batch(self, this_task: Task, modified_file_set: Set[str], other_op_list: List[PathOp]):
        ...
        assert this_task.priority == ExecPriority.LIVE_UPDATE
