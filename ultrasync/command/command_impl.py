...
#                 assert isinstance(self._model.src_node, LocalFileNode)
#                 assert isinstance(self._model.dst_node, LocalFileNode)
...
#
#             # Add to cache:
#             local_node = LocalDirNode(self._model.node_identifier, True)
#             context.cache_manager.add_or_update_node(local_node)
#             self._status = CommandStatus.COMPLETED_OK
#         except Exception as err:
...
#                 assert isinstance(self._model, FileToUpdate)
#
#                 assert isinstance(self._model.src_node, LocalFileNode), f'For {self._model.src_node}'
