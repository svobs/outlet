    ...
    def build_command_batch(self, change_tree: SubtreeSnapshot = None, delete_list: List[DisplayNode] = None) -> CommandBatch:
        ...
        if change_tree:
            ...
            while len(stack) > 0:
                ...
                # Don't even bother to create commands for display-only nodes such as LocalDirNodes, etc
                # TODO: refactor to create commands for LocalDirNodes for better control
